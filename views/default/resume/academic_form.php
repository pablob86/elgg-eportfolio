...
<div class="contentWrapper">
    <form action="<?php echo $vars['url']; ?>action/<?php echo $action ?>"
        ...
        <p><?php echo elgg_echo('resume:academic:level'); ?><br />
            <?php echo elgg_view('input/text', array('internalname' => 'level', 'value' => $vars['entity']->level)); ?></p>

        <p><?php echo elgg_echo('resume:academic:institution'); ?><br />
            <?php echo elgg_view('input/text', array('internalname' => 'institution', 'value' => $vars['entity']->institution)); ?></p>

        <p><?php echo elgg_echo('resume:academic:achieved_title'); ?><br />
            <?php echo elgg_view('input/text', array('internalname' => 'achieved_title', 'value' => $vars['entity']->achieved_title)); ?></p>
            

        <p><?php echo elgg_echo('resume:academic:enddate'); ?><br />
